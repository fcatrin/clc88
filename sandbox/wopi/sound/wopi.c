...
static void set_algorithm(voice_t *voice, UINT8 value);
...
/*
    ...
    040 - 048 : voice algorithm                           mask: 00000100
    050 - 073 : opi wave type                             mask: 00000101 | 00000110 | 00000111
        ...
        for(int voice_index = 0; voice_index < 1; voice_index++) {
            ...
            if (voice->algorithm == 2) {
                ...
                for(int opi_index = 3; opi_index >=0; opi_index--) {
                    ...
                    int opi_envelope = opi_value * (env_value / 255.0);
                    int opi_final = opi_envelope * (opi->volume / 255.0);
                    if (opi_index != 2) voice_final += opi_final;
                    modulation = opi_final >> 4;
                }
                voice_final *= (voice->volume / 255.0);
            }
